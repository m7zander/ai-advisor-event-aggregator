...
- Bei `https://`-Basisendpoint dürfen signal-spezifische Endpoint-Overrides (`OTEL_EXPORTER_OTLP_TRACES_ENDPOINT`, `..._METRICS_ENDPOINT`, `..._LOGS_ENDPOINT`) nicht mit `http://` beginnen.
