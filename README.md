...
- `OTEL_EXPORTER_OTLP_ENDPOINT` (Default: `http://localhost:4318`, als OTLP-HTTP-Basisendpoint mit optionalem Pfadpräfix wie `/otel`; Signalpfade `/v1/...` werden vom Exporter ergänzt; keine eingebetteten Credentials/Userinfo)
