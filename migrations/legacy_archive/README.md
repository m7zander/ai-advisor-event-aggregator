...
Dieses Verzeichnis enthält bewusst **keine** ausführbaren SQL-Migrationen mehr.
...
Hinweis: Der Runtime-Startup-Pfad bleibt unverändert ausschließlich `Repository.Migrate`.
